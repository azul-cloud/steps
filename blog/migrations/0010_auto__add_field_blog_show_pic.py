...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blog.show_pic'
        db.add_column('blog_blog', 'show_pic',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blog.show_pic'
        db.delete_column('blog_blog', 'show_pic')
    ...
    models = {
        'blog.blog': {
            ...
            'show_pic': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
