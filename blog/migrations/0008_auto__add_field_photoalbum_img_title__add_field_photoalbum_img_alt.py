...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PhotoAlbum.img_title'
        db.add_column('blog_photoalbum', 'img_title',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'PhotoAlbum.img_alt'
        db.add_column('blog_photoalbum', 'img_alt',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PhotoAlbum.img_title'
        db.delete_column('blog_photoalbum', 'img_title')

        # Deleting field 'PhotoAlbum.img_alt'
        db.delete_column('blog_photoalbum', 'img_alt')
